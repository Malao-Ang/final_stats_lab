...
*  1.1 ตอบเป็นกราฟสมมาตร ดังนั้นเป็นกราฟมาจากการแจกแจงปกติ
*  1.2 จงประมาณค่าแบบจุดของข้อมูลน้ําหนักไขมันเฉลี่ยในแฮมเบอร์เกอร์ยี่ห้อนี้ 1.2 ตอบ 29.071429
...
"""1.3 ช่วงของข้อมูลน้ําหนักไขมันเฉลี่ยในแฮมเบอร์เกอร์ยี่ห้อนี้ ด้วยความเชื่อมั่น 99% = 25.73667078134093-32.40618636151621"""
...
data= [39.9 ,39.1, 27.8, 34.2, 30.3, 25.7, 33.2, 28.0 ,18.9, 23.8 ,29.9 ,39.0 ,35.0 ,30.4, 28.9, 15.9, 35.2, 
       24.3 ,19.4 ,27.3 ,37.4 ,24.3, 33.4, 14.5, 16.0, 21.1, 36.4, 33.4, 22.0, 36.7 ,30.7, 34.7 ,23.1, 28.8 ,38.8]
stat,p = shapiro(data)
print('stat = %.3f, p = %.3f\n' %(stat,p))
if p> 0.05:
...
"""1.4 ข้อมูลนำหนักไขมันเฉลี่ยนี้มากจากประชากรมีการแจกแจงแบบปกติ
...
"""2.1 ช่วงความเช่ือม่ัน 90% ของจานวนคร้ังของการเต้นของหัวใจโดยเฉลี่ย =89.47994580728773, 91.85338752604561"""
...
"""2.2 ช่วงความเช่ือม่ัน 95% ของจานวนคร้ังของการเต้นของหัวใจโดยเฉลี่ย = 89.22157017299917, 92.11176316033418"""
...
"""3.ตอบ ยอมรับ H0 ที่ระดับนัยสำคัญ0.1 คือ อายุเฉลี่ยจริงของหญิงไทยเฉลี่ยมากกว่า70 ปี(u<= 70)

3.1 เป็นการแจกแจงแบบปกติใช้T-test
"""